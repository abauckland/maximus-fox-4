...
#used
  ...
  scope :show_cawssubsection_speclines, ->(project_id, cawssubsection_id, clausetype_id) { includes(:txt1, :txt3, :txt4, :txt5, :txt6, :identity => [:identkey, :identvalue], :perform => [:performvalue, :performkey], :clause => [:clausetitle, :guidenote, :clauseref => [:subsection]]
